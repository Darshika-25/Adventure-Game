...
//*************************ENEMY VARIABLES*****************************/
let enemies: string[] = ["Skeleton", "Zombie", "Dragon", "Assassin"];
let maxEnemyHealth: number = 75; // Maximum health of enemy
let enemyAttackDamageToHero: number = 25; // Maximum attack damage an enemy
...
Game: while (gameRunning) {
  ...
  console.log(
    chalk.bold.underline.yellowBright(`\t# ${enemy} has appeared #\n`)
  );
  ...
  while (enemyHealth > 0) {
    ...
    if (options.answer === " 1. Attack ") {
      ...
      console.log(
        chalk.bold.magenta(
          `You striked the ${enemy} for damage ${damageToEnemy}`
        )
      );
      console.log(
        chalk.bold.yellowBright(
          `${enemy} striked you for ${damageToHero} damage`
        )
      );
      ...
      if (numHealthpotion > 0) {
        ...
        console.log(
          chalk.yellowBright(
            `You used the health potion for ${healthPotionHealAmount}`
          )
        );
        console.log(chalk.blueBright(`You have ${heroHealth} health!`));
        console.log(
          chalk.greenBright(`You have ${numHealthpotion} health potions left!`)
        );
      } else {
        console.log(
          chalk.redBright(
  ...
  if (heroHealth < 1) {
    console.log(
      chalk.redBright(
        "Your strength has failed you. You are too wounded to continue!"
      )
    );
    break;
  }
  ...
  if (randomNumber < healthPotionDropChance) {
    ...
    console.log(
      chalk.cyanBright(
        "The enemy dropped a health potion. Your health is restored!"
      )
    );
    console.log(chalk.greenBright(`Your health is ${heroHealth}!`));
    console.log(
      chalk.ansi256(180)(`Your health potion is ${numHealthpotion}!`)
    );
  }
